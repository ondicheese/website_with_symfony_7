 ...
 */
final class Version20241008132914 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, roles, password, firstname, lastname, email FROM user');
        ...
        $this->addSql('INSERT INTO user (id, username, roles, password, firstname, lastname, email) SELECT id, username, roles, password, firstname, lastname, email FROM __temp__user');
